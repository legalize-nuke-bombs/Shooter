...
namespace Shooter.Server.Worlds
{
    public class ServerWorld
    {
        ...
        public ServerWorld(string id)
        {
            ...
            entities.Add(NpcCreator.Create(new Nameable(NameableType.Kapsul), capsuleHealth, new Inventory(), new GeminiTalker(GeminiModel.Flash35, "Тебя зовут Капсул. Ты первый NPC добавленный в игру. Ты дружелюбный и эмпатичный. Ты помогаешь игроку.", capsuleHealth, clock), new Vector3(0f, 1.1f, 16f)));
