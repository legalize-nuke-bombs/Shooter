namespace Shooter.Server.Worlds.Entities.Parts.Talker.Gemini
{
    public class GeminiSettings
    {
        public string BaseSystemPrompt { get; private set; } =
            ...
            "Если игрок просит тебя спрашивает о том, что ты не знаешь, или просит сделать что-то, для чего у тебя нет инструментов, то ты находишь лучшую отговорку не отвечать или не делать.";
    }
}
