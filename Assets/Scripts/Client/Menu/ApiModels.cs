...
namespace Shooter.Client.Menu
{
    ...
    public class WorldDto { public string Id { get; set; } public string Name { get; set; } public long CreatedAt { get; set; } public string JoinPolicy { get; set; } public List<PlayerDto> Players { get; set; } }
    public class WorldsWrap { public List<WorldDto> Items { get; set; } }
