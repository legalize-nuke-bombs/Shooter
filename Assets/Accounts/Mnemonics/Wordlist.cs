...
namespace Shooter.Accounts.Mnemonics
{
    public static class Wordlist
    {
        ...
        {
            return Lookup.TryGetValue(word, out int index) ? index : -1;
        }

        private static Dictionary<string, int> lookup;

        private static Dictionary<string, int> Lookup => lookup ??= Build();

        private static Dictionary<string, int> Build()
        {
            var built = new Dictionary<string, int>(Words.Length);
