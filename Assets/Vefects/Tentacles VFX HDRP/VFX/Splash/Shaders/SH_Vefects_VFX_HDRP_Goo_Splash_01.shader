...
Shader "Vefects/SH_Vefects_VFX_HDRP_Goo_Splash_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord165 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float temp_output_174_0 = ( packedInput.ase_texcoord5.z + saturate( clampResult9_g2 ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord165 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( packedInput.ase_texcoord2.z + saturate( clampResult9_g2 ) );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord165 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( packedInput.ase_texcoord1.z + saturate( clampResult9_g2 ) );
				float2 texCoord10 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord70 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner72 = ( 1.0 * _Time.y * _NoiseTextureDistortionPan + ( texCoord70 * _NoiseTextureDistortionScale ));
				float lerpResult61 = lerp( -1.0 , 1.0 , tex2D( _NoiseTextureDistortion, panner72 ).g);
				float2 temp_cast_0 = (lerpResult61).xx;
				float2 lerpResult63 = lerp( float2( 0,0 ) , temp_cast_0 , _NoiseDistortionLerp);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord165 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( packedInput.ase_texcoord3.z + saturate( clampResult9_g2 ) );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord165 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( packedInput.ase_texcoord7.z + saturate( clampResult9_g2 ) );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
...
WireConnection;184;5;25;0
WireConnection;184;6;51;0
WireConnection;184;7;48;0
WireConnection;184;9;176;0
ASEEND*/
//CHKSM=9CF45EF521044D59B26932AEC1A19E1A324AFFA2