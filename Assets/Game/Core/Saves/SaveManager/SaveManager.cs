...
/*
 * TODO
 * Я нашел баг в сохранениях. Подбираем грибы. Сохраняемся. Загружаемся. Грибы спавнятся сразу а не через 24 игровых часа.
 * Я насколько понял это связано с тем что каким-то образом на некоторых объектах проскакивают вызовы Update до того как весь мир загрузится.
 * Грибы загружаются до часов Update ResourceItem проверяет время часов и не некорректному (еще не загруженному) времени спавнит обратно грибы.
 * Я заебался завтра стоит починить
 */
