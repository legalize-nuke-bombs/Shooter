        ...
        private Prompt InterNpcInteractionPrompt(string takenInterNpcInteractions) =>
            new Prompt()
                .Section("Общение с другими NPC",
                    "Ты можешь сказать что-то другому или другим NPC, используя поле ответа `interNpcInteractions`.\n" +
                    ...
                    "Ты постоянно делишься любой новой информацией о мире с NPS поблизости.\n" +
