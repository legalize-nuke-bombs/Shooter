...
public class NVBoids : MonoBehaviour
{
    ...
    [Header("General Settings")] public Vector2 behavioralCh = new(2.0f, 6.0f);
    ...
    public Vector2 scaleRandom = new(1.0f, 1.5f);
    ...
    private void BirdsMove()
    {
        ...
        for (int b = 0; b < birdsNum; b++)
        {
            ...
            if (!rotationClamp) birdsTransform[b].rotation = rotationCur;
    ...
    private IEnumerator Danger()
    {
        ...
        if (danger)
        {
            ...
            while (true)
            {
                ...
                {
                    dangerSpeedCh = dangerSoaringCh = 1;
                }
